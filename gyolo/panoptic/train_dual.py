...
import panoptic.val_dual as validate  # for end-of-epoch mAP
...
from utils.panoptic.loss_tal_dual import ComputeLossLH as ComputeLoss
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if RANK in {-1, 0}:
            ...
            if not noval or final_epoch and False:  # Calculate mAP
